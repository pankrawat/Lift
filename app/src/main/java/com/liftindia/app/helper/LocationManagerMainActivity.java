...
public class LocationManagerMainActivity implements LocationListener, ConnectionCallbacks, OnConnectionFailedListener, ResultCallback<LocationSettingsResult>,
        android.location.LocationListener {

    private Activity activity;
    private LocationHandlerListener listener;
    private static LocationManagerMainActivity instance;
    ...
    private LocationManagerMainActivity(Activity activity) {
        this.activity = activity;
    }

    public static LocationManagerMainActivity getInstance(Activity activity) {
        if (instance == null) {
            instance = new LocationManagerMainActivity(activity);
        }
        return instance;
    }

    public LocationManagerMainActivity buildAndConnectClient() {
    ...
    public LocationManagerMainActivity setLocationHandlerListener(LocationHandlerListener listener) {
        this.listener = listener;
        return this;
    }

    public LocationManagerMainActivity buildLocationRequest() {
        if (settingReq == null) {
    ...
    public void onResult(LocationSettingsResult result) {
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                try {
                    if (activity != null && isMainActivityForeground) {
                        status.startResolutionForResult(activity, REQUEST_CHECK_SETTINGS);
                    }

                    /*else if (activity != null && activity instanceof HomeActivity && isRideActive) //force user to enable location
                    {
                        status.startResolutionForResult(activity, REQUEST_CHECK_SETTINGS);
                    }*/
