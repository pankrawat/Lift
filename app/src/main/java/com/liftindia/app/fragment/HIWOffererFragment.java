 ...
 */
public class HIWOffererFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_offerer, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imageView1:
                displayImageZoom(R.drawable.off_1);
                break;
            case R.id.imageView2:
                displayImageZoom(R.drawable.off_2);
                break;
            case R.id.imageView3:
                displayImageZoom(R.drawable.off_3);
                break;
