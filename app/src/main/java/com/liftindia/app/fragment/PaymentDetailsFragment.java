...
/**
 * Created by sandeep on 15-04-2016.
 */
public class PaymentDetailsFragment extends Fragment implements View.OnClickListener, RatingBar.OnRatingBarChangeListener {
...
//        pref.putString(Const.REQUESTER_ID, Const.getUserId(activity));
//        pref.putString(Const.LIFT_ID, bean.liftId);
//        pref.putString(Const.OFFERER_ID, bean.userId);
/*
        try {
        ...
        try {
            if (Helper.isConnected(activity)) {
                if(!rating.equals("0")) {
                    ...
                    jsonObject.addProperty(Const.TO_ID, bean.userId);
                    ...
                    Log.e("obj", "API_RATE_USER input: " + jsonObject.toString());
