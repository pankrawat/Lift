...
public class CaldroidFragment extends DialogFragment {
    ...
    public CaldroidFragment(DataMap dataMap) {
        this.dbmap = dataMap;
    }
    ...
    public CaldroidGridAdapter getNewDatesGridAdapter(int month, int year) {
        return new CaldroidGridAdapter(getActivity(), month, year,
                getCaldroidData(), extraData, dbmap, true);
    }
...
//        if (!d.equals(CalendarHelper.convertDateToDateTime(new Date()))) {
            ...
            if (today == null) {
                ...
                ((TextView) v).setBackgroundResource(R.drawable.selected_circle_bg);
            } else {
                //remove selected
                ...
                ((TextView) v).setBackgroundColor(getActivity().getResources().getColor(R.color.white));
            }
//        }
    }
